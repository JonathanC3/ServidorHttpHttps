...
import static com.sun.javafx.tk.quantum.QuantumToolkit.verbose;
...
public class Handlers {
	...
	public static class RootHandler implements HttpHandler {
        ...
        public void handle(HttpExchange he) throws IOException {
            byte[] encoded = Files.readAllBytes(
                    Paths.get("C:/Users/jcast/OneDrive/Documents/NetBeansProjects/Ejemplo ServidorHttp/src/ejemploservidorhttp/data/index.html"));
            he.sendResponseHeaders(200, encoded.length);
            he.getResponseHeaders().set("Content-Type","text/html;charset=utf-8");
